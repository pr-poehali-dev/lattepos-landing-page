...
import {
  ...
  DASHBOARD_IMG, NETWORK_IMG, SHOP_SCHEME_IMG, FASTFOOD_SCHEME_IMG, RESTAURANT_SCHEME_IMG, LOGO_IMG,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`relative opacity-0 ${demoSection.inView ? "animate-slide-in-right" : ""}`}
              ...
              <div className="relative rounded-2xl overflow-hidden" style={{ border: "1px solid rgba(74,153,144,0.25)" }}>
                <img src={activeTab === 0 ? SHOP_SCHEME_IMG : activeTab === 1 ? FASTFOOD_SCHEME_IMG : RESTAURANT_SCHEME_IMG} alt="LattePOS" className="w-full h-auto" />
              </div>
            </div>
          </div>
        </div>
