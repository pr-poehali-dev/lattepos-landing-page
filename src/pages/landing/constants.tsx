...
export const features = [
  { icon: "Printer", title: "Поддержка торгового оборудования", desc: "Поддерживает работу со всем перечнем торгового оборудования: фискальные регистраторы, эквайринговые терминалы, сканеры ШК, принтеры ШК, весы, табло покупателей, программируемые клавиатуры и т.д.", color: TERRA },
  { icon: "ArrowLeftRight", title: "Обмен данных с 1С", desc: "Обмен данными с товар-учетной программой 1С происходит каждые 15 минут, что даёт возможность анализа и планирования остатков на торговых точках в реальном времени, по всей сети.", color: TEAL },
  { icon: "BadgePercent", title: "Программа лояльности", desc: "Бонусные карты, скидки, персонализированные предложения для постоянных клиентов, приложение для клиентов на мобильном устройстве.", color: TERRA_LIGHT },
  { icon: "SwitchCamera", title: "Несколько режимов работы", desc: "В режиме кассира, в режиме кассы самообслуживания, в режиме фастфуда, в режиме ресторана.", color: TEAL_LIGHT },
  { icon: "LayoutDashboard", title: "Удобный интерфейс администрирования", desc: "Для администрирования всех кассовых рабочих мест, групповые обработки и планы обслуживания.", color: TERRA },
  { icon: "CloudDownload", title: "Актуальные обновления", desc: "Обновления в соответствии с текущим законодательством: всегда актуальная версия по работе с ЕГАИС, маркированным товаром, драйверами оборудования и ОФД.", color: TEAL },
];
